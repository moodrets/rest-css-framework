...
const PlaygroundItem = () => {
  ...
  return(
    <div className="mb-4 sh-2 p-5 pos-rel">
      <textarea onInput={e=>setClassList(e.target.value)} placeholder="Element class list (with space)" className="rsz-y wd-full mb-7 p-3 out-n rds-4 bdr bdr-wd-2 bdr-secondary"></textarea>
