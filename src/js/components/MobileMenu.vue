<template>
  <div class="rs-mobile-menu pos-fx pos-cover-0 z-100 group-active" :class="visible ? 'is-active' : 'vs-h'" @click="clickHandler">
    <div class="bg-dark pos-fx pos-cover-0 z-1-neg op-70 pe-n"></div>
    <div class="p-6 wd-280 bg-light sh-2 trs-03 trf trf-slide-left trf-slide-left:ga pos-fx pos-cover-0 pos-r-a ov-y-a">
